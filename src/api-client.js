...
export async function getStudents() {
  const response = await fetch(`${API_BASE_URL}/students.php?action=list`, {
    credentials: 'include'
  });
...
export async function addStudent(formData) {
  const response = await fetch(`${API_BASE_URL}/students.php?action=add`, {
    method: 'POST',
    credentials: 'include',
    body: formData
  });
...
export async function deleteStudent(id) {
  const response = await fetch(`${API_BASE_URL}/students.php?action=delete&id=${id}`, {
    method: 'GET',
    credentials: 'include'
  });
...
export async function getLecturers() {
  const response = await fetch(`${API_BASE_URL}/lecturers.php?action=list`, {
    credentials: 'include'
  });
...
export async function addLecturer(formData) {
  const response = await fetch(`${API_BASE_URL}/lecturers.php?action=add`, {
    method: 'POST',
    credentials: 'include',
    body: formData
  });
...
export async function deleteLecturer(id) {
  const response = await fetch(`${API_BASE_URL}/lecturers.php?action=delete&id=${id}`, {
    method: 'GET',
    credentials: 'include'
  });
